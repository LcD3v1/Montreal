...
const C_VITORIA = '#ffffff'
const C_EMPATE  = '#8a8a8a'
...
function MarbleStrip() {
  return (
    <svg width="100%" height="100%" preserveAspectRatio="xMaxYMid slice">
      <rect width="100%" height="100%" filter="url(#mf-strip)" />
    </svg>
  )
}
  ...
  return (
    <div className="mtl-main">
      <div className="main-inner">
        ...
        {/* HERO */}
        <div className="hero">
          <div className="hero-marble"><MarbleFull /></div>
          <div className="hero-marble-side">
            <svg width="100%" height="100%" preserveAspectRatio="xMaxYMid slice">
              <rect width="100%" height="100%" filter="url(#mf-strip)" />
            </svg>
          </div>
          <div className="scan" />
          <h1>FACÇÃO <em>MONTREAL</em></h1>
        ...
        <div className="stats">
          {[
            ...
            <div className="stat" key={i}>
              <div className="marble-strip"><MarbleStrip /></div>
        ...
        <div className="row2">
          <div className="icard">
            <div className="card-marble"><MarbleFull /></div>
            <div className="card-title"><span className="dot" />RESULTADOS · TIRO</div>
            <div className="donut-wrap">
              <div className="donut-rel">
                <svg width="130" height="130" viewBox="0 0 130 130">
                  <circle cx="65" cy="65" r="50" fill="none" stroke="#1A0808" strokeWidth="16" />
                  <circle cx="65" cy="65" r="57" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="1" strokeDasharray="3 15" />
                  {donut.map((seg, i) => (
                    <circle
                      key={i}
