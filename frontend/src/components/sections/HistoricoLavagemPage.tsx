  ...
  return (
    <div className="p-6 space-y-4 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <GlowCard><div className="p-4"><p className="font-mono text-[10px] text-txt2 tracking-wider">DIFERENÇA (taxa)</p><p className="font-orbitron text-lg text-gold mt-1">{fmtMoney(totSujo - totLimpo)}</p></div></GlowCard>
      </div>
