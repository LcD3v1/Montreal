...
import MarbleDefs from '@/components/ui/MarbleDefs'
...
export default function LoginPage() {
  ...
  return (
    <div className="relative h-screen w-screen bg-bg flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <source src="/Montreal.mp4" type="video/mp4" />
      </video>

      {/* Overlay escuro + mármore em baixa opacidade (deixa o fundo mais escuro) */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="card-marble" style={{ opacity: 0.12 }}>
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 38%, rgba(60,0,0,0.30), transparent 60%),' +
              'linear-gradient(rgba(8,5,5,0.80), rgba(4,2,2,0.92))',
          }}
        />
        <div className="absolute inset-0 hex-grid-bg" style={{ opacity: 0.06 }} />
      </div>

      {/* Partículas (por cima do vídeo) */}
