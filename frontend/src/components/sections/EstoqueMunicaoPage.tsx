...
export default function EstoqueMunicaoPage() {
  ...
  function darEntrada() {
    ...
    if (!id) { addToast('error', 'Selecione a arma.'); return }
          ...
          <div className="p-4">
            ...
            <div className="flex items-end gap-2 flex-wrap">
              <div className="flex-1 min-w-[180px]">
                <label htmlFor="e-municao" className="block font-mono text-[10px] text-txt3 tracking-wider mb-1">ARMA</label>
            ...
            {linhas.length === 0 && (
              <p className="font-mono text-[10px] text-txt3 mt-2">
                Nenhum tipo de arma cadastrado. Cadastre em Configurações.
              </p>
            )}
          </div>
        </GlowCard>
      ...
      <GlowCard>
        <div className="p-4">
          <h3 className="font-orbitron text-xs text-txt2 tracking-wider mb-4 flex items-center gap-2">
            <Package size={14} className="text-gold" /> ESTOQUE DE ARMAS
          </h3>
