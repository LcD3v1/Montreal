...
import { useBauGerenciaMovimentos, useDeleteBauGerenciaMovimento, useDeleteBauGerenciaMovimentosLote } from '@/hooks/useBauGerencia'
...
export default function HistoricoBauGerenciaPage() {
  ...
  const deleteLote = useDeleteBauGerenciaMovimentosLote()
